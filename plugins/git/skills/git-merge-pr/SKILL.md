---
name: git-merge-pr
description: Use when the user wants to squash-merge a GitHub PR — /git-merge-pr, "PR 머지", "squash merge", or any request to merge a pull request into main
user_invocable: true
---

# git-merge-pr — PR Squash Merge
