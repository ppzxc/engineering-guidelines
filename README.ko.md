...
| [git](./plugins/git) | v0.0.7 | Git 워크플로우 스킬 — 안전한 커밋, PR 생성, PR 리뷰, squash merge, 이슈 생성, PR 전체 흐름, worktree 정리 |
| [workflow](./plugins/workflow) | v0.0.4 | 워크플로우 스킬 — Gemini를 활용한 멀티 LLM 크로스체크 기반 계획 및 실행 |
