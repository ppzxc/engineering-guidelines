...
|--------|---------|-------------|
| [guideline](./plugins/guideline) | v0.7.0 | Software engineering guidelines and coding principles — including RESTful API guidelines, Andrej Karpathy's 11 coding principles, and the Honest Judgment anti-sycophancy review rule |
