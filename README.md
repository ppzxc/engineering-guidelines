...
|--------|---------|-------------|
| [api](./plugins/api) | v0.0.11 | RESTful API design guidelines — URL structure, HTTP methods, status codes, JSON format, error responses, versioning, headers, non-CRUD action endpoints |
