...
|--------|---------|-------------|
| [api](./plugins/api) | v0.0.7 | RESTful API design guidelines — URL structure, HTTP methods, status codes, JSON format, error responses, versioning, headers, non-CRUD action endpoints |
