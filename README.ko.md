...
| 플러그인 | 버전 | 설명 |
|--------|------|------|
| [guideline](./plugins/guideline) | v0.1.0 | 소프트웨어 엔지니어링 가이드라인 및 코딩 원칙 — RESTful API 가이드라인 및 Andrej Karpathy의 11가지 코딩 행동 지침 포함 |
| [workflow](./plugins/workflow) | v0.1.0 | 오케스트레이션된 개발 프로세스 워크플로우 스킬 — 고강도 개발 기율 강제를 위한 init, idea, feature, develop, planning 스킬 포함 |
...
| [llm](./plugins/llm) | v0.1.3 | LLM 위임 스킬 — agy (Antigravity CLI) 컨텍스트 맵 생성, claude 정밀 분석 및 auto 양방향 교차검증 |
