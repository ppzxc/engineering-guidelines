...
|--------|---------|-------------|
| [guideline](./plugins/guideline) | v0.5.1 | Software engineering guidelines and coding principles — including RESTful API guidelines, Andrej Karpathy's 11 coding principles, and the Honest Judgment anti-sycophancy review rule |
