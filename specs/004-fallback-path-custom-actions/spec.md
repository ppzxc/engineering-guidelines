...
- **FR-001**: [SKILL.md](file:///home/ppzxc/projects/engineering-guidelines/plugins/guideline/skills/restful-api/SKILL.md)의 Actions 섹션에 콜론 구문을 사용할 수 없는 환경을 위한 대체 서브패스(`/orders/{id}/cancel` 등) 패턴 가이드 규정을 추가한다.
- **FR-002**: [docs/adr/0005-adopt-aip-resource-oriented-design-and-colon-custom-methods.md](file:///home/ppzxc/projects/engineering-guidelines/docs/adr/0005-adopt-aip-resource-oriented-design-and-colon-custom-methods.md)에 대체 라우팅 규격을 수용하는 의사결정 기록을 부분 업데이트한다.\n\n## Success Criteria *(mandatory)*\n\n### Measurable Outcomes\n\n- **SC-001**: Implement the criteria outlined in acceptance scenarios.\n\n## Assumptions\n\n- Assumed target integration behaves according to standard conventions.\n