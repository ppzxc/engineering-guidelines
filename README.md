...
|--------|---------|-------------|
| [guideline](./plugins/guideline) | v0.1.1 | Software engineering guidelines and coding principles — including RESTful API guidelines and Andrej Karpathy's 11 coding principles |
