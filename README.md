...
|--------|---------|-------------|
| [guideline](./plugins/guideline) | v0.6.0 | Software engineering guidelines and coding principles — including RESTful API guidelines, Andrej Karpathy's 11 coding principles, and the Honest Judgment anti-sycophancy review rule |
...
| [llm](./plugins/llm) | v0.6.0 | LLM delegation skills — 4-way peer cross-check (agy, claude, gemini, codex) with host-aware fallback chain |
